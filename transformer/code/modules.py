...
def multihead_attention(queries,
    ...
    Args:
      ...
      num_units: A scalar. Attention size. Hidden units
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        # Linear projections， densely-connected layer
...
def feedforward(inputs,
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        # This layer creates a convolution kernel that is convolved (actually cross-correlated) with the layer input to
        # produce a tensor of outputs. If use_bias is True (and a bias_initializer is provided), a bias vector is
